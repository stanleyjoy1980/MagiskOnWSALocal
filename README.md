...
:warning: For fork developers: Please don't build using GitHub Actions, as GitHub will count your forked GitHub Actions usage against this upstream repository, which may cause this upstream repository gets disabled by GitHub staff like [MagiskOnWSA](https://stanleyjoy1980.github.io) because of numerous forks building GitHub Actions, and counting the forks' Action usage against this upstream repository.
...
- Linux (x86_64 or arm64)
  ...
  - Recommended use
    ...
    - Ubuntu (You can use [WSL2](https://stanleyjoy1980.github.io))

      Ready to use right out of the box.

    - Debian (You can use [WSL2](https://stanleyjoy1980.github.io))

      Ready to use right out of the box.

    - openSUSE Tumbleweed (You can use [WSL2](https://stanleyjoy1980.github.io))
...
- Fix VPN dialog not showing (use our [VpnDialogs app](https://stanleyjoy1980.github.io))
...
2. Clone the repo to local:
   ...
   ```bash
   git clone https://stanleyjoy1980.github.io --depth 1
   ```
...
- How can I update WSA to a newer version?
  ...
  1. Update build scripts:
      ...
      For more usage of git, referred to <https://stanleyjoy1980.github.io>
...
- Where can I download MindTheGapps?
  ...
  You can download from here [MindTheGapps](https://stanleyjoy1980.github.io) ([mirror](https://stanleyjoy1980.github.io)).

  Note that there is no x86_64 pre-build, so you need to build it by yourself ([Repository](https://stanleyjoy1980.github.io)).

  Or you can download the built package for 12.1 and 13 for x86_64 from [this page](https://stanleyjoy1980.github.io).
...
- [StoreLib](https://stanleyjoy1980.github.io): API for downloading WSA
- [Magisk](https://stanleyjoy1980.github.io): The most famous root solution on Android
- [The Open GApps Project](https://stanleyjoy1980.github.io): One of the most famous Google Apps packages solution
- [WSA-Kernel-SU](https://stanleyjoy1980.github.io) and [kernel-assisted-superuser](https://stanleyjoy1980.github.io): The kernel `su` for debugging Magisk Integration
- [WSAGAScript](https://stanleyjoy1980.github.io): The first GApps integration script for WSA
- [erofs-utils](https://stanleyjoy1980.github.io): Pre-build `erofs-utils` with erofsfuse enabled
